...
button(this, DEFAULT_WIDTH / 2,DEFAULT_HEIGHT - 100, 'button_UI',10, 'Main Menu', 40, 0.5, true, () => { 
  ...
  create() {
    const currentscene = 20;
    const musicname = "empire";
    var textdisplay =
    "Téng Hou, realizing his grave mistake, tried to save her, but it was too late. As she exploded into a myriad of lights, Téng Hou, holding his all-knowing machine, perished with her.";
    var audioname = "ténghoure";
    let result = "";
