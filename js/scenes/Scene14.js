...
button(this, DEFAULT_WIDTH / 2,DEFAULT_HEIGHT - 100, 'button_UI',10, 'Main Menu', 40, 0.5, true, () => { 
  ...
  create() {
    const currentscene = 14;
    const musicname = "empire";
    var textdisplay =
    "Determined to be with her, Téng Hou embarked on an ambitious quest. He created an all-knowing machine, a marvel that could answer any question. Through this machine, he unraveled the secrets of the cosmos, automating the celestial duties so Suàn shén could stay with him.";
    var audioname = "determined";
    let result = "";
