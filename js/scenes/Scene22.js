...
class Scene22 extends Phaser.Scene {
  ...
  add_buttons(currentscene) {
    //Add UI Buttons
       //Add UI Buttons
       button(this, DEFAULT_WIDTH - 250,DEFAULT_HEIGHT - 100, 'button_UI',10, 'Back', 40, 0.5, true, () => { 
...
button(this, DEFAULT_WIDTH / 2,DEFAULT_HEIGHT - 100, 'button_UI',10, 'Main Menu', 40, 0.5, true, () => { 
  ...
  create() {
    const currentscene = 22;
    const musicname = "empire";
    var textdisplay =
    "Thus ended the tale of Téng Hou and Suàn shén, a story of love, loss, and the consequences of crossing cosmic boundaries.";
    var audioname = "thusendedt";
    let result = "";
