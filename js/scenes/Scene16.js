...
button(this, DEFAULT_WIDTH / 2,DEFAULT_HEIGHT - 100, 'button_UI',10, 'Main Menu', 40, 0.5, true, () => { 
  ...
  create() {
    const currentscene = 16;
    const musicname = "empire";
    var textdisplay =
    "But Suàn shén's response was a tranquil departure from his dreams. \"We are bound by cosmic boundaries, Téng Hou. I cannot stay,\" she said, her voice echoing like a distant lullaby.";
    var audioname = "butsuànshé";
    let result = "";
