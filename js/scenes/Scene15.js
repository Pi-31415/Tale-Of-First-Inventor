...
button(this, DEFAULT_WIDTH / 2,DEFAULT_HEIGHT - 100, 'button_UI',10, 'Main Menu', 40, 0.5, true, () => { 
  ...
  create() {
    const currentscene = 15;
    const musicname = "empire";
    var textdisplay =
    "Triumphantly, he presented his achievement to her. \"Now, you can remain with me forever,\" he said, hope shining in his eyes.";
    var audioname = "triumphant";
    let result = "";
