...
button(this, DEFAULT_WIDTH / 2,DEFAULT_HEIGHT - 100, 'button_UI',10, 'Main Menu', 40, 0.5, true, () => { 
  ...
  create() {
    ...
    var textdisplay =
    "One fateful day, a figure in a red robe, like a petal against the green, caught Téng Hou's eye. Her beauty was unparalleled, and in awe, he greeted her. Their eyes met, and a connection sparked.";
    var audioname = "onefateful";
    let result = "";
