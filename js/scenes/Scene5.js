...
class Scene5 extends Phaser.Scene {
  ...
  add_buttons(currentscene) {
    ...
    button(this, DEFAULT_WIDTH - 250,DEFAULT_HEIGHT - 100, 'button_UI',10, 'Next', 40, 0.5, true, () => { 
      this.scene.start("Scene6"); //comment this finally   
  });
  button(this, 250,DEFAULT_HEIGHT - 100, 'button_UI',10, 'Back', 40, 0.5, true, () => { 
    this.scene.start("Scene4"); //comment this finally   
});
...
button(this, DEFAULT_WIDTH / 2,DEFAULT_HEIGHT - 100, 'button_UI',10, 'Main Menu', 40, 0.5, true, () => { 
  ...
  create() {
    ...
    var textdisplay =
      "With pride, Téng Hou explained his craft, demonstrating the intricate movements. The lady watched, her eyes reflecting admiration. Then, with a mysterious glimmer, she offered to show him a surprise. From her robes, she drew forth a brush and paper, writing words unknown, and with a playful chant, the puppets came to life, moving on their own.";
    var audioname = "withpride";
    let result = "";
