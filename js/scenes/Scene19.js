...
button(this, DEFAULT_WIDTH / 2,DEFAULT_HEIGHT - 100, 'button_UI',10, 'Main Menu', 40, 0.5, true, () => { 
  ...
  create() {
    const currentscene = 19;
    const musicname = "empire";
    var textdisplay =
    "Eventually, she appeared to Téng Hou, her form fading. \"I am dying,\" she whispered, \"and it is because of the secrets you shared.\"";
    var audioname = "eventually";
    let result = "";
