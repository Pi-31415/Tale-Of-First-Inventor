...
button(this, DEFAULT_WIDTH / 2,DEFAULT_HEIGHT - 100, 'button_UI',10, 'Main Menu', 40, 0.5, true, () => { 
  ...
  create() {
    const currentscene = 8;
    const musicname = "empire";
    var textdisplay =
    "As days turned to nights, their bond deepened into love. Téng Hou's curiosity about her powers grew. \"Could you teach me your ways?\" he asked one starlit evening, under a moonless sky. \"To breathe life into my creations?\"";
    var audioname = "asdaysturn";
    let result = "";
