...
button(this, DEFAULT_WIDTH / 2,DEFAULT_HEIGHT - 100, 'button_UI',10, 'Main Menu', 40, 0.5, true, () => { 
  ...
  create() {
    const currentscene = 18;
    const musicname = "empire";
    var textdisplay =
    "But humans, driven by greed, misused the technology, exploiting the robots and machines. This abuse drained Suàn shén's life force, causing her great pain.";
    var audioname = "buthumans";
    let result = "";
