...
button(this, DEFAULT_WIDTH / 2,DEFAULT_HEIGHT - 100, 'button_UI',10, 'Main Menu', 40, 0.5, true, () => { 
  ...
  create() {
    ...
    var textdisplay =
    "Each evening, as the sun dipped below the horizon, Téng Hou would retreat to the serene lakeside, filled with lilies dancing in the breeze. There, he played his flute, its melodies intertwining with the whispers of the wind. His puppets, his silent companions, watched on, basking in the harmony.";
    var audioname = "eachevenin";
    let result = "";
