...
class Scene7 extends Phaser.Scene {
  ...
  add_buttons(currentscene) {
    ...
    button(this, DEFAULT_WIDTH - 250,DEFAULT_HEIGHT - 100, 'button_UI',10, 'Next', 40, 0.5, true, () => { 
      this.scene.start("Scene8"); //comment this finally   
  });
...
button(this, DEFAULT_WIDTH / 2,DEFAULT_HEIGHT - 100, 'button_UI',10, 'Main Menu', 40, 0.5, true, () => { 
  ...
  create() {
    ...
    var textdisplay =
    "The lady revealed herself as Suàn shén, the Goddess of Algorithms, a being from another realm, tasked with keeping the cosmos in motion.";
    var audioname = "theladyrev";
    let result = "";
