...
button(this, DEFAULT_WIDTH / 2,DEFAULT_HEIGHT - 100, 'button_UI',10, 'Main Menu', 40, 0.5, true, () => { 
  ...
  create() {
    const currentscene = 17;
    const musicname = "empire";
    var textdisplay =
    "Heartbroken, Téng Hou watched her leave. As time passed, his sorrow aged him, and in his loneliness, he shared his knowledge with humanity, hoping to ease his pain.";
    var audioname = "heartbroke";
    let result = "";
